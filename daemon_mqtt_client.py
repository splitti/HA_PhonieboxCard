...
arAvailableCommands = ['volumeup', 'volumedown', 'mute', 'playerplay', 'playerpause', 'playernext', 'playerprev', 'playerstop', 'playerrewind', 'playershuffle', 'playerreplay', 'scan', 'shutdown', 'shutdownsilent', 'reboot', 'disablewifi', 'toggleoled', 'togglebuttonsleds']
...
arAvailableAttributes = ['volume', 'mute', 'repeat', 'random', 'state', 'file', 'artist', 'albumartist', 'title', 'album', 'track', 'elapsed', 'duration', 'trackdate', 'last_card', 'maxvolume', 'volstep', 'idletime', 'rfid', 'gpio', 'remaining_stopafter', 'remaining_shutdownafter', 'remaining_idle', 'throttling', 'temperature', 'buttonledservice', 'oledservice']
...
def fetchData():
    ...
    result["oledservice"] = isServiceRunning("phoniebox-gpio-buttons.service")
    result["buttonledservice"] = isServiceRunning("phoniebox_led_control.service")
